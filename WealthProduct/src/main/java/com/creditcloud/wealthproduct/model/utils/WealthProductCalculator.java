...
package com.creditcloud.wealthproduct.model.utils;
...
import com.creditcloud.wealthproduct.model.WealthProductRepaymentDetail;
 ...
 * 理财产品还款计算
 * 
 * copy from（com.creditcloud.common.calculator.LoanCalculator）
 * 
 * @author suetming <suetming.ma at creditcloud.com>
 */
public class WealthProductCalculator {
     ...
     * @return
     */
    public static WealthProductRepaymentDetail analyzeNew(final int amount,
                                                          final Duration duration,
                                                          final int rate,
                                                          final RepaymentMethod method,
                                                          final LocalDate asOfDate) {
        LocalDate local;
        WealthProductRepaymentDetail model = analyze(amount, duration, rate, method, asOfDate);
        List<Repayment> list = model.getRepayments();
        if (list != null) {
     ...
     * @return
     */
    public static WealthProductRepaymentDetail analyze(final int amount,
                                     final Duration duration,
                                     final int rate,
                                     final RepaymentMethod method,
                                     final LocalDate asOfDate) {
     ...
     * @return
     */
    public static WealthProductRepaymentDetail analyze(final BigDecimal amount,
                                                       final Duration duration,
                                                       final int rate,
                                                       final RepaymentMethod method,
                                                       final LocalDate asOfDate,
        ...
        switch (method) {
            ...
            case MonthlyInterest: //按period付息，到期还本
                ...
                //create result
                result = new WealthProductRepaymentDetail(principal, interest, duration, method, new ArrayList<Repayment>());
                //add amortized items
