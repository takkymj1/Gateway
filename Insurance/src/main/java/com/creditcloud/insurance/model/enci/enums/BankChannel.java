...
public enum BankChannel implements BaseEnum{
    ...
    PLESCC("民生电销信用卡", "8600061", "民生电销信用卡"),
    DLB("大连银行", "8600440", "大连银行"),
    HXB("华夏银行", "8600160", "华夏银行"),
    NJCB("南京银行", "8600530", "南京银行"),
    HERCC("河北农信社", "8600111", "河北省农村信用社"),
    ICBCB("北分工商银行", "8600011", "北分工商银行"),
    CCBBIL("建行银保通", "8600021", "建行银保通"),
    ZGNYYH("中国农业银行", "8600051", "中国农业银行"),
    BCC("信用卡银行", "8600001", "信用卡银行"),
    PINGAN("平安银行", "8600490", "平安银行");
