...
public interface ChinaPayService {
	 ...
	 *         类似于 :{serviceType=1028, certType=01, signature=F2956936EFD95F8C272A37C4A6F73D5A,
	 *         dcType=0, save=false, respcode=0000, cardNo=6226620607792207,
	 *         certNo=231002198903302089, appSysId=90000, respmsg=null, usrName=刘琳驰, channelId=19,
	 *         signMethod=MD5}<br>
	 *         当 respcode为"0000"表示这是一个真实存在的银行卡号,其他值分别表示一些错误(ChinaPay用户系统_账户认证接口文档V1.0.7.docx):<br>
	 * <br>
