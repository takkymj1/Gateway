...
public interface CouponService extends CouponQueryService {
    ...
    /**
     * 根据Type以及parValue，寻找合适的package，并将其中一张奖券分配给owner.
     * 
     * 条件是parValue和type都相符合，package没有过期并且有可分配的奖券数量
     * 
     * @param clientCode
     * @param type
     * @param parValue
     ...
     */
    public CouponPlacement placeCoupon(String clientCode, CouponType type, int parValue, RealmEntity owner);
