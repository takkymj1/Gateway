 ...
 */
@XmlRootElement
public class FinanceInfo extends BaseObject implements Jsonizable<FinanceInfo> {
    //是否有房
    ...
    @Override
    public FinanceInfo fromJsonString(String jsonString) {
