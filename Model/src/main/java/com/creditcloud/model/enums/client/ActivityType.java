...
public enum ActivityType implements BaseEnum {
    ...
    LOANREQUEST_ASSIGN_MANAGER("分配客户经理", Realm.LOAN_REQUEST),
    LOANREQUEST_ASSIGN_TASK("分配外审任务", Realm.LOAN_REQUEST),
    LOANREQUEST_VISIT_REVIEW("实地征信", Realm.LOAN_REQUEST),
    LOANREQUEST_RISK_REVIEW("风控评审", Realm.LOAN_REQUEST),
