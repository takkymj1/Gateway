...
public interface UserAssetService {
     ...
     * @return
     */
    public RealEstate addRealEstate(String clientCode, RealEstate estate, Source source, Proof... proof);
     ...
     * @return
     */
    public boolean updateRealEstate(String clientCode, RealEstate estate, Source source);
