 ...
 * @author rooseek
 */
public class PosWhSaveRequest extends UserRequest {
    ...
    public PosWhSaveRequest() {
    }

    public PosWhSaveRequest(String MerCustId,
                            String UsrCustId,
                            String OpenAcctId,
                            String TransAmt,
                            String OrdId,
                            ...
                            String RetUrl,
                            String BgRetUrl) {
        super(CmdIdType.PosWhSave, MerCustId, UsrCustId);
