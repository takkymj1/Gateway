...
public class TradeEntRechargeRequest extends BaseRequest {
    ...
    public TradeEntRechargeRequest(String sign_type, 
                                   String charset, 
                                   String res_format, 
                                   String sign, 
                                   String mer_id, 
                                   ...
                                   String gate_id, 
                                   String user_ip) {
        super(CmdIdType.MER_RECHARGE, sign_type, charset, res_format, sign, mer_id, version);
    ...
    public TradeEntRechargeRequest(String mer_id, 
                                   ...
                                   String gate_id, 
                                   String user_ip) {
        super(CmdIdType.MER_RECHARGE, UmpConstant.SIGN_TYPE, UmpConstant.ENCODE_TYPE, UmpConstant.RESPONSE_FORMAT, "", mer_id, UmpConstant.CURRENT_VERSION);
        this.ret_url = ret_url;
        this.notify_url = notify_url;
        this.order_id = order_id;
        this.mer_date = mer_date;
